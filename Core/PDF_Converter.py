...
class Menu:
    ...
    def CreateTemplate(Template,Content,filename,htmlcontent,username):
        ...
        <body>
         <p>PDF REPORT FOR {} GRAPH</p>
          <div class = "Metadata">
            ...
            <p>PDF GENERATED BY MR.CODEHACKER</p>
            <p>GENERATED ON: {}</p>
            <p>MR.CODEHACKER DOWNLOAD LINK: https//github.com/Lucksi/Mr.CodeHacker</p>
           </div>
            <br>
            {}
        </body>
        ...
        choice = int(input(
                Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(langfile, "Transfer", "Question", "None") + Font.Color.GREEN + "[#MR.CODEHACKER#]" + Font.Color.WHITE + "-->"))
        if choice == 1:
